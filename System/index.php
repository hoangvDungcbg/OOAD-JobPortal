...
<head>
    ...
    <meta property="og:image:alt" content="Online Job Portal" />
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="employees.php">Applicants</a>
							</li>
					...
					<div class="nav-mini-wrapper">
						...
						print '
							...
							<li><a class="register-btn" data-toggle="modal" href="#registerModal">Register</a></li>';						
						}
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employer" class="btn btn-facebook btn-block mb-5-xs">Register as Companies</a>
						</div>
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">Register as Applicants</a>
						</div>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/02.jpg');">
				<div class="container">
					...
					<p>Finding your next job or career here</p>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Online Job Portal</h5>
											<p>Online Job Portal is a job portal, online job management system developed by N7 - UET in 2022.</p>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											...
											<li><a href="../employees.php">Applicants</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : UET - VNU, Hanoi</p>
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">20020000@vnu.edu.vn</a></p>
								<p>Phone : <a href="tel:+233546607474">+84 123 456 789</a></p>
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								<ul class="bottom-footer-menu for-social">
									<li><a target="_blank" href="<?php echo "https://twitter.com/"; ?>"><i class="ri ri-twitter" data-toggle="tooltip" data-placement="top" title="twitter"></i></a></li>
									<li><a target="_blank" href="<?php echo "https://www.facebook.com/"; ?>"><i class="ri ri-facebook" data-toggle="tooltip" data-placement="top" title="facebook"></i></a></li>
									<li><a target="_blank" href="<?php echo "https://www.instagram.com/"; ?>"><i class="ri ri-instagram" data-toggle="tooltip" data-placement="top" title="instagram"></i></a></li>
								</ul>
							</div>
